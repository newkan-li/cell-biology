    ...
    ch.modules.forEach(function (m, mi) {
      ...
      m.slides.forEach(function (s, si) {
        ...
        if (s.anim) {
          ...
          ifr.setAttribute("data-src", "anim/" + s.anim + ".html?embed=1&v=20260926b");
